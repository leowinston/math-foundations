...
determining how many collisions accumulate. Since chain traversal costs $\mathcal{O}(k)$ where 
$k$ is the chain length, a lower load factor keeps $k$ near $1$, keeping 
lookup performance at $\mathcal{O}(1)$, while a higher load factor trades this for less frequent resizes.\\
